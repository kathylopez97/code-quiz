...
var questionSource = [
    {
        ...
        choices:[ "a. Hyper Type Multi Language",
    ...
    },
    {
        ...
        question: "Question 3 : What does the Touch (command) do?",
        choices: [
            "a. create file",
            "b. delete file",
            "c. remove file",
...
function checkAnswer(event) {
    ...
    if (questionSource[questionNumber].answer == event.target.value) {
        ...
        checkLine.textContent = "Incorrect! The correct answer is " + questionSource[questionNumber].answer + " .";
    }
